...
class Cabinet
{
    ...
    #[ORM\Column(length: 255)]
    #[Assert\NotBlank(message:"Veuillez saisir l'adresse svp. Le champ est vide'.")]
    private ?string $adresse = null;

    #[ORM\Column]
    #[Assert\NotBlank(message:"Veuillez saisir le code postal svp. Le champ est vide.")]
    private ?int $codepostal = null;

    #[ORM\Column(length: 255)]
    #[Assert\NotBlank(message:"Veuillez saisir votre adresse mail svp. Le champ est vide.")]
    private ?string $adressemail = null;

    #[ORM\ManyToOne(inversedBy: 'cabinets')]
    #[ORM\JoinColumn(name: 'id_medecin', referencedColumnName: 'id')]
    #[Assert\NotBlank(message:"Veuillez choisir un Nutritionniste svp.")]

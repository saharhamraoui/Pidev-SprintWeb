 ...
 */
final class Version20240416021147 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE donation (idDon INT AUTO_INCREMENT NOT NULL, idCamp INT NOT NULL, valeurDon INT NOT NULL, idDonator INT NOT NULL, history DATE DEFAULT NULL, INDEX idDonator_FK (idDonator), INDEX idCamp (idCamp), PRIMARY KEY(idDon)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE reservation (reservationId INT AUTO_INCREMENT NOT NULL, userId INT DEFAULT NULL, dateTime DATETIME DEFAULT NULL, tableId INT DEFAULT NULL, numberOfPersons INT DEFAULT NULL, INDEX tableId (tableId), INDEX idUser (userId), PRIMARY KEY(reservationId)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');

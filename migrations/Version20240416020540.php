 ...
 */
final class Version20240416020540 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rdv ADD idCabinet VARCHAR(255) DEFAULT NULL, DROP id_cabinet, CHANGE id id VARCHAR(255) NOT NULL, CHANGE email email VARCHAR(50) NOT NULL, CHANGE dateRdv daterdv DATE DEFAULT NULL');
        $this->addSql('ALTER TABLE rdv ADD CONSTRAINT FK_10C31F865C546E42 FOREIGN KEY (idCabinet) REFERENCES cabinet (id)');
        $this->addSql('CREATE INDEX IDX_10C31F865C546E42 ON rdv (idCabinet)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rdv DROP FOREIGN KEY FK_10C31F865C546E42');
        $this->addSql('DROP INDEX IDX_10C31F865C546E42 ON rdv');
        $this->addSql('ALTER TABLE rdv ADD id_cabinet INT NOT NULL, DROP idCabinet, CHANGE id id INT NOT NULL, CHANGE email email VARCHAR(255) NOT NULL, CHANGE daterdv dateRdv DATE NOT NULL');
